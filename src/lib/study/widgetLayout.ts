...
export const DEFAULT_WIDGET_LAYOUT: WidgetLayout = {
  ...
  cards: [
    { id: "cards-decks",      visible: true, size: "half", order: 0 },
    { id: "cards-toolbar",    visible: true, size: "half", order: 1 },
    { id: "cards-pinned",     visible: true, size: "half", order: 2 },
    { id: "cards-categories", visible: true, size: "half", order: 3 },
